      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-muted">L'élégance au poignet, livrée partout en Algérie.</p>
          </div>
            ...
            <div className="flex items-center gap-4 text-muted">
              <a href="#" aria-label="Facebook" className="hover:text-text transition">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22 12.07C22 6.48 17.52 2 11.93 2 6.35 2 1.87 6.48 1.87 12.07c0 4.78 3.44 8.74 7.94 9.68v-6.84H7.6v-2.84h2.21v-2.17c0-2.18 1.3-3.38 3.28-3.38.95 0 1.94.17 1.94.17v2.12h-1.09c-1.07 0-1.41.66-1.41 1.34v1.61h2.4l-.38 2.84h-2.02v6.84c4.5-.94 7.94-4.9 7.94-9.68Z" />
                </svg>
              </a>
